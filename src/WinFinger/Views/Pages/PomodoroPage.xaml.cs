...
public partial class PomodoroPage : UserControl, IIslandPage
{
    ...
    private void Refresh()
    {
        ...
        PhaseLabel.Text = pomodoro.Phase switch
        {
            ...
            PomodoroPhase.Break => pomodoro.IsRunning ? "On a break" : "Break paused",
            _ => "Ready to focus"
        };
        ...
        StatsLabel.Text = pomodoro.CompletedFocusCount > 0 ? $"{pomodoro.CompletedFocusCount} focus sessions completed today" : "";
    }
}
